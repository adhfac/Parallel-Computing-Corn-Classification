...
logger.info("="*70)
logger.info("SERIAL BENCHMARK STARTED")
logger.info("="*70)
...
for idx, ds in enumerate(datasets, start=1):
    ...
    logger.info(
        f"[DATASET {ds}] Phase 1/3 → Loading image paths..."
    )
    ...
    logger.info(
        ...
        f"Initializing SERIAL model inference..."
    )
    ...
    logger.info(
        f"[DATASET {ds}] Model inference FINISHED"
    )
    ...
    logger.info(
        f"[DATASET {ds}] Phase 3/3 → Calculating metrics..."
    )
...
logger.info("")
logger.info("="*70)
logger.info("SERIAL BENCHMARK COMPLETED")
logger.info("="*70)